...
<body>
    ...
    <div class="homecontent">
        ...
        <h3><a href="register.php" class="btn btn-success">Create New Member Here!!</a></h3>   
    ...
    while($res = mysqli_fetch_array($result)) {         
       ...
       echo "<td><a href=\"edit.php?id=$res[id]\" class='btn btn-success'>Edit</a> </td>";
       echo "<td><a href=\"delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\" class='btn btn-danger'>Delete</a></td>";        
    }   
    ?>   
    </table> 
